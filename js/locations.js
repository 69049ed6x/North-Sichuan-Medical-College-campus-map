...
window.CAMPUS_LOCATIONS = [
  { id: 'outdoor-pool', name: '室外游泳池', x: 438, y: 18, width: 155, height: 40, images: ['assets/locations/outdoor-pool-1.webp'] },
  { id: 'talent-apartment', name: '人才公寓', x: 760, y: 50, width: 150, height: 43, images: ['assets/locations/talent-apartment-1.webp'] },
  ...
  { id: 'ganlu-college', name: '甘露书院', x: 926, y: 306, width: 160, height: 46, images: ['assets/locations/ganlu-college-1.webp'] },
  ...
  { id: 'deqi-building', name: '德启楼（第二教学楼）', x: 1918, y: 360, width: 155, height: 60, images: ['assets/locations/deqi-building-1.webp'] },
  { id: 'siyuan-building', name: '思源楼', x: 2048, y: 198, width: 100, height: 42, images: ['assets/locations/siyuan-building.webp'] },
  { id: 'heyuan', name: '和园', x: 2105, y: 60, width: 100, height: 42, images: ['assets/locations/heyuan-1.webp'] },
  ...
  { id: 'ruiyuan-restaurant', name: '瑞园餐厅', x: 2210, y: 638, width: 150, height: 42, images: ['assets/locations/ruiyuan-restaurant-1.webp'] },
  { id: 'ruiyuan', name: '瑞园', x: 2380, y: 680, width: 95, height: 45, images: ['assets/locations/ruiyuan-1.webp'] },
